...
De Users worden geplitst in TrainUsers, ValidateUsers en TestUsers zodat deze op de juiste plekken in het trainen, valideren en testen van het model kunnen worden gebruikt. Op het einde worden de kolommen "Randomgerecht" en "One out" uit de dataset gehaald aangezien deze alleen voor visualisatie van de train dataset was.
